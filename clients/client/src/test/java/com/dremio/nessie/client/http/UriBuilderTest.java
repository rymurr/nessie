...
class UriBuilderTest {
  ...
  void parameterValidation() {
    assertAll(
        () -> assertThrows(NullPointerException.class,
            () -> new UriBuilder(null)),
        () -> assertThrows(NullPointerException.class,
            () -> new UriBuilder("http://base/")
                               .path(null)),
        () -> assertThrows(NullPointerException.class,
            () -> new UriBuilder("http://base/")
                               .resolveTemplate(null, "value")),
        () -> assertThrows(NullPointerException.class,
            () -> new UriBuilder("http://base/")
                               .resolveTemplate("name", null))
    );
  }
  ...
  void pathTemplates() {
    ...
    assertEquals(
        String.format("Cannot build uri. Not all template keys (%s) were used in uri %s",
                      "{no}",
                      "{my-var}/something/{in}/here"),
